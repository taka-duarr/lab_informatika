...
export default function AdminPraktikumIndexPage({
    ...
    const [updateStatus, setUpdateStatus] =
        useState<UpdateStatus>(updateStatusInit);
    ...
    const handleUpdateStatus = (id: string, newStatus: boolean) => {
        ...
        axios
            .post(route("praktikum.update-status"), {
                id: id,
                status: newStatus,
            })
            .then((res) => {
    ...
    const columns: ColumnDef<Praktikum>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                const isCurrStatusSubmit =
                    updateStatus.id === originalRow.id && updateStatus.onSubmit;
                return (
                    <>
    ...
    return (
        <AdminLayout auth={auth}>
            ...
            <CardDescription>Data Praktikum yang terdaftar</CardDescription>
            <div className="flex flex-col lg:flex-row gap-2 items-start justify-between">
                <Button
                    className="mt-4"
                    onClick={() =>
                        router.visit(route("admin.praktikum.create"))
                    }
                >
                    Buat <Plus />
                </Button>
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="flex flex-col gap-0.5">
                            ...
                            <p className="*:text-red-600">
                                ...
                                kuis dan sebagainya akan kehilangan
                                keterangannya.
                            </p>
                            <br />
                            <p className="text-red-600">
