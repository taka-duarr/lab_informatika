...
export default function AdminPraktikumDetailsPage({
    auth,
    praktikum,
    jenisPraktikums,
    periodePraktikums,
    ...
    const [selectedYear, setSelectedYear] = useState<number>(
        Number(praktikum.tahun)
    );

    const handleUpdateForm = (
        key: keyof UpdateForm,
    ...
    const handleUpdateFormSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        const updateSchema = z.object({
            nama: z
                ...
                .min(1, { message: "Nama Praktikum wajib diisi!" }),
            jenis_praktikum_id: z
                .string({ message: "Format Modul tidak valid! " })
                .min(1, { message: "Modul wajib dipilih!" }),
            periode_praktikum_id: z
                .string({ message: "Format Periode Praktikum tidak valid! " })
                .min(1, { message: "Periode Praktikum wajib dipilih!" }),
            tahun: z
                .number({ message: "Tahun Praktikum wajib diisi!" })
                .min(1, { message: "Tahun Praktikum wajib diisi!" }),
        });
    ...
    const handleSubmitCreateSesi = (event: FormEvent<HTMLFormElement>) => {
        ...
        const { nama, kuota, isUnlimited, hari, waktu_mulai, waktu_selesai } =
            createSesi;
        const sesiSchema = z.object({
            nama: z
                .string({ message: "Format nama tidak valid! " })
                .min(1, { message: "Nama Sesi Praktikum wajib diisi!" }),
        });
    ...
    const handleOpenUpdateSesi = (
        open: boolean,
        initState: UpdateSesi = updateSesiInit
    ) => {
    ...
    const handleSubmitDeleteSesi = (event: FormEvent<HTMLFormElement>) => {
        ...
        const deleteSchema = z.object({
            id: z
                .string({ message: "Format Sesi Praktikum tidak valid! " })
                .min(1, { message: "Format Sesi Praktikum tidak valid!" }),
        });
    ...
    const [createPertemuan, setCreatePertemuan] =
        useState<CreatePertemuan>(createPertemuanInit);
    const [updatePertemuan, setUpdatePertemuan] =
        useState<UpdatePertemuan>(updatePertemuanInit);
    const [deletePertemuan, setDeletePertemuan] =
        useState<DeletePertemuan>(deletePertemuanInit);
    ...
    const handleSubmitCreatePertemuan = (event: FormEvent<HTMLFormElement>) => {
        ...
        const pertemuanSchema = z.object({
            nama: z
                .string({ message: "Format nama tidak valid! " })
                .min(1, { message: "Nama Pertemuan Praktikum wajib diisi!" }),
        });
    ...
    const handleChangeUpdatePertemuan = (
        key: keyof UpdatePertemuan,
    ...
    const handleSubmitUpdatePertemuan = () => {
        ...
        const updateSchema = z.object({
            id: z
                .string({ message: "Format Modul tidak valid! " })
                .min(1, { message: "Format Pertemuan Praktikum tidak valid!" }),
            nama: z
                .string({ message: "Format nama Modul tidak valid! " })
                .min(1, { message: "Nama Pertemuan Praktikum wajib diisi!" }),
        });
        const updateParse = updateSchema.safeParse({
            id: id,
    ...
    const handleSubmitDeletePertemuan = (event: FormEvent<HTMLFormElement>) => {
        ...
        const deleteSchema = z.object({
            id: z
                .string({ message: "Format Pertemuan Praktikum tidak valid! " })
                .min(1, { message: "Format Pertemuan Praktikum tidak valid!" }),
        });
        const deleteParse = deleteSchema.safeParse({
            id: id,
    ...
    const [createModul, setCreateModul] =
        useState<CreateModul>(createModulInit);
    const [updateModul, setUpdateModul] =
        useState<UpdateModul>(updateModulInit);
    const [deleteModul, setDeleteModul] =
        useState<DeleteModul>(deleteModulInit);
    ...
    const handleSubmitCreateModul = (event: FormEvent<HTMLFormElement>) => {
        ...
        const modulSchema = z.object({
            nama: z
                .string({ message: "Format nama tidak valid! " })
                .min(1, { message: "Nama Modul Praktikum wajib diisi!" }),
            topik: z
                .string({ message: "Format topik tidak valid! " })
                .min(1, { message: "Topik Modul Praktikum wajib diisi!" }),
            pertemuan_id: z
                .string({ message: "Format Pertemuan modul tidak valid! " })
                .min(1, {
                    message: "Pertemuan Modul Praktikum wajib disertakan!",
                }),
        });
    ...
    const handleChangeUpdateModul = (
        key: keyof UpdateModul,
        value: string | boolean
    ) => {
    ...
    const handleSubmitUpdateModul = () => {
        ...
        const updateSchema = z.object({
            id: z
                .string({ message: "Format Modul tidak valid! " })
                .min(1, { message: "Format Modul tidak valid!" }),
            nama: z
                .string({ message: "Format nama Modul tidak valid! " })
                .min(1, { message: "Nama Modul wajib diisi!" }),
            topik: z
                .string({ message: "Format topik Modul tidak valid! " })
                .min(1, { message: "Topik Modul wajib diisi!" }),
        });
        const updateParse = updateSchema.safeParse({
            id: id,
            nama: nama,
    ...
    const handleOpenDeleteModul = (modul: { id: string; nama: string }) => {
    ...
    return (
        <>
            <AdminLayout auth={auth}>
                ...
                <CardTitle>Memperbarui data Praktikum</CardTitle>
                ...
                >
                    <div className="flex flex-col md:flex-row gap-3 flex-wrap md:items-center">
                        <Label className="flex-1 min-w-72 grid gap-2">
                            Jenis Praktikum
                            <Select
                                value={updateForm.jenis_praktikum_id}
                                onValueChange={(value) =>
                                    handleUpdateForm(
                                        "jenis_praktikum_id",
                                        value
                        ...
                        <Label className="flex-1 min-w-72 grid gap-2">
                            Periode Praktikum
                            <Select
                                value={updateForm.periode_praktikum_id}
                                onValueChange={(value) =>
                                    handleUpdateForm(
                                        "periode_praktikum_id",
                                        value
                            ...
                            >
                                ...
                                <SelectContent>
                                    {periodePraktikums
                                        .sort(
                                            (a, b) =>
                                                romanToNumber(a.nama) -
                                                romanToNumber(b.nama)
                                        )
                                        .map((jenis, index) => (
                                            <SelectItem
                                                key={index}
                    ...
                    <div className="flex flex-col md:flex-row gap-3 flex-wrap md:items-center">
                        <div className="grid gap-2 flex-1 min-w-72">
                            ...
                            <Input
                                ...
                                onChange={(event) =>
                                    handleUpdateForm("nama", event.target.value)
                                }
                            />
                        </div>
                            ...
                            <div className="basis-1/2 flex flex-row gap-1.5 items-center">
                                <IconSwitch
                                    ...
                                    onCheckedChange={(checked) =>
                                        handleUpdateForm("status", checked)
                                    }
                    ...
                    <Button
                        ...
                        disabled={
                            updateForm.onSubmit ||
                            !updateForm.nama ||
                            !updateForm.jenis_praktikum_id ||
                            !updateForm.periode_praktikum_id ||
                            !isOnChange
                        }
                    ...
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {praktikum.sesi_praktikum.length > 0 && (
                            <Button
                                size="sm"
                                className="-mt-3"
                                onClick={() => handleOpenCreateSesi(true)}
                            >
                    ...
                    <div className="space-y-4">
                        {praktikum.sesi_praktikum.length > 0 ? (
                            praktikum.sesi_praktikum.map((sesi) => (
                                <Card
                                    key={sesi.id}
                                    className="rounded-sm shadow-none border-muted-foreground/40 !py-1"
                                >
                                    <div className="flex flex-row gap-2 justify-between">
                                        ...
                                        <div className="p-6 space-x-1 content-center">
                                            <Button
                                                size="icon"
                                                variant="ghost"
                                                className="group hover:bg-red-500/85"
                                                onClick={() =>
                                                    handleOpenDeleteSesi({
                                                        id: sesi.id,
                                                        nama: sesi.nama,
                                                    })
                                                }
                                            ...
                                            <Button
                                                size="icon"
                                                variant="ghost"
                                                className="group hover:bg-blue-500/85"
                                                onClick={() =>
                                                    handleOpenUpdateSesi(
                                                        true,
                                                        mapToUpdateSesi(sesi)
                                                    )
                                                }
                                                disabled={!!updateSesi.id}
                                            >
                ...
                <CardContent className="p-0">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {praktikum.pertemuan.length > 0 && (
                            <Button
                                size="sm"
                                className="-mt-3"
                                onClick={() => setOpenCreatePertemuan(true)}
                            >
                    ...
                    <div className="space-y-4">
                        {praktikum.pertemuan.length > 0 ? (
                                ...
                                >
                                    <div className="flex flex-row gap-2 justify-between">
                                        <CardHeader>
                                            ...
                                            pertemuan.id ? (
                                                <Input
                                                    value={updatePertemuan.nama}
                                                    onChange={(event) =>
                                                        handleChangeUpdatePertemuan(
                                                            "nama",
                                                            event.target.value
                                                        )
                                                    }
                                                ...
                                                <>
                                                    <Button
                                                        ...
                                                        disabled={
                                                            updatePertemuan.id ===
                                                                pertemuan.id &&
                                                            updatePertemuan.nama ===
                                                                pertemuan.nama
                                                        }
                                                        onClick={
                                                            handleSubmitUpdatePertemuan
                                                        }
                                                    >
                                    ...
                                    <CardContent>
                                        ...
                                        <div className="space-y-2">
                                            {pertemuan.modul.length > 0 ? (
                                                pertemuan.modul.map((modul) => (
                                                    <Card
                                                        key={modul.id}
                                                        className="rounded-sm shadow-none border-muted-foreground/40"
                                                    >
                                                                ...
                                                                modul.id ? (
                                                                    ...
                                                                    <>
                                                                        <Button
                                                                            ...
                                                                            onClick={() =>
                                                                                handleOpenDeleteModul(
                                                                                    {
                                                                                        id: modul.id,
                                                                                        nama: `${modul.nama} - ${pertemuan.nama}`,
                                                                                    }
                                                                                )
                                                                            }
                                                                        >
                                                                        ...
                                                                        <Button
                                                                            size="icon"
                                                                            className="bg-blue-600 hover:bg-blue-600/85"
                                                                            onClick={() =>
                                                                                handleOpenUpdateModul(
                                                                                    modul
                                                                                )
                                                                            }
                                                                            disabled={
                                                ...
                                                <Card className="rounded-sm shadow-none border-muted-foreground/40">
                                                    <CardContent className="p-2.5 flex justify-between items-center gap-1">
                                                        <p className="text-xs italic text-gray-500/90 font-medium">
                            ...
                            <Card className="h-32 rounded-sm shadow-none border-muted-foreground/40 flex flex-col items-center justify-center gap-3">
                                <p className="text-sm">
                                    Belum ada data pertemuan praktikum
                                </p>
                                <Button
                                    size="sm"
                                    className="mt-4"
                ...
                <AlertDialog
                    open={openCreateSesi}
                    onOpenChange={handleOpenCreateSesi}
                >
                    <AlertDialogContent
                    ...
                    >
                        ...
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitCreateSesi}
                        >
                                ...
                                <div className="flex items-end gap-2">
                                    <div className="grid gap-1 text-center">
                                        ...
                                        <TimePickerInput
                                            ...
                                            onRightFocus={() =>
                                                createSesiMulaiMinuteRef.current?.focus()
                                            }
                                        />
                                    </div>
                                    ...
                                    <div className="grid gap-1 text-center">
                                        ...
                                        <TimePickerInput
                                            ...
                                            onRightFocus={() =>
                                                createSesiSelesaiMinuteRef.current?.focus()
                                            }
                                        />
                                    </div>
                                    <p className="mb-1 font-bold">:</p>
                ...
                <AlertDialog
                    open={openUpdateSesi}
                    onOpenChange={handleOpenUpdateSesi}
                >
                    <AlertDialogContent
                        className="my-alert-dialog-content"
                        onOpenAutoFocus={(e) => e.preventDefault()}
                    >
                        ...
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitUpdateSesi}
                        >
                            <div className="grid gap-2">
                                <Label htmlFor="nama">
                                    Nama Sesi Praktikum
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="items-center flex gap-1.5">
                                    <Checkbox
                                        id="unlimited-kuota-update"
                                        checked={updateSesi.isUnlimited}
                                        onCheckedChange={(checked) =>
                                            setUpdateSesi((prevState) => ({
                                                ...prevState,
                                                isUnlimited: !!checked,
                                    ...
                                    />
                                    <Label
                                        htmlFor="unlimited-kuota-update"
                                        className="text-sm opacity-80"
                                    >
                                        Kuota tidak terbatas
                                    </Label>
                                ...
                                <div className="flex items-end gap-2">
                                    <div className="grid gap-1 text-center">
                                        ...
                                        <TimePickerInput
                                            ...
                                            onRightFocus={() =>
                                                updateSesiMulaiMinuteRef.current?.focus()
                                            }
                                        />
                                    </div>
                                    <p className="mb-1 font-bold">:</p>
                                    ...
                                    <div className="grid gap-1 text-center">
                                        ...
                                        <TimePickerInput
                                            ...
                                            onRightFocus={() =>
                                                updateSesiSelesaiMinuteRef.current?.focus()
                                            }
                                        />
                                    </div>
                                    <p className="mb-1 font-bold">:</p>
                ...
                <AlertDialog
                    open={openDeleteSesi}
                    onOpenChange={setOpenDeleteSesi}
                >
                    <AlertDialogContent
                        ...
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="flex flex-col gap-0.5">
                                ...
                                <span className="*:text-red-600">
                                    Semua data Modul,Kuis,Nilai Praktikan yang
                                    terkaitdengan{" "}
                                    <strong>"{deleteSesi.nama}"</strong> akan
                                    juga dihapus
                                </span>
                                <br />
                                <span className="text-red-600">
                                    Data yang terhapus tidak akan bisa
                                    dikembalikan! harap gunakan dengan hati-hati
                                </span>
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitDeleteSesi}
                        >
                            <div className="grid gap-2">
                                ...
                                />
                                <p>
                                    Ketik <strong>INFORMATIKA JAYA</strong>{" "}
                                    untuk melanjutkan
                                </p>
                            </div>
                            <Button
                                ...
                                disabled={
                                    deleteSesi.onSubmit ||
                                    deleteSesi.validation !== "INFORMATIKA JAYA"
                                }
                            >
                                {deleteSesi.onSubmit ? (
                                    <>
                ...
                <AlertDialog
                    open={openCreatePertemuan}
                    onOpenChange={setOpenCreatePertemuan}
                >
                    <AlertDialogContent
                        className="max-w-[90%] sm:max-w-[425px] rounded"
                        onOpenAutoFocus={(e) => e.preventDefault()}
                    >
                        ...
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitCreatePertemuan}
                        >
                            <div className="grid gap-2">
                                <Label htmlFor="nama">
                                    Nama Pertemuan Praktikum
                                </Label>
                                <Input
                                    type="text"
                                    name="nama"
                            ...
                            <Button
                                type="submit"
                                disabled={createPertemuan.onSubmit}
                            >
                ...
                <AlertDialog
                    open={openDeletePertemuan}
                    onOpenChange={setOpenDeletePertemuan}
                >
                    <AlertDialogContent
                        className="max-w-[90%] sm:max-w-[425px] rounded"
                        onOpenAutoFocus={(e) => e.preventDefault()}
                    >
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="flex flex-col gap-0.5">
                                ...
                                <span className="*:text-red-600">
                                    Semua data Modul,Kuis,Nilai Praktikan yang
                                    terkaitdengan{" "}
                                    <strong>"{deletePertemuan.nama}"</strong>{" "}
                                    akan juga dihapus
                                </span>
                                <br />
                                <span className="text-red-600">
                        ...
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitDeletePertemuan}
                        >
                            <div className="grid gap-2">
                                <Label htmlFor="validation">
                                    Validasi aksi anda
                ...
                <AlertDialog
                    open={openCreateModul}
                    onOpenChange={setOpenCreateModul}
                >
                    <AlertDialogContent
                        className="max-w-[90%] sm:max-w-[425px] rounded"
                        onOpenAutoFocus={(e) => e.preventDefault()}
                    >
                        <AlertDialogHeader>
                            <AlertDialogTitle>
                                Tambah Modul{" "}
                                {praktikum.pertemuan.find(
                                    (pertemuan) =>
                                        pertemuan.id ===
                                        createModul.pertemuan_id
                                )?.nama ?? ""}
                            </AlertDialogTitle>
                            <AlertDialogDescription className="flex flex-col gap-0">
                                ...
                                <span>
                                    Topik Modul seperti{" "}
                                    <strong>"COMMAND LINE INTERFAFACE"</strong>
                                </span>
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitCreateModul}
                        >
                            <div className="grid gap-2">
                            ...
                            <Button
                                ...
                                disabled={
                                    ...
                                    !createModul.nama ||
                                    !createModul.topik ||
                                    createModul.nama === createModulInit.nama
                                }
                            >
                                {createModul.onSubmit ? (
                                    <>
                        ...
                        <AlertDialogCancel
                            onClick={() => setCreateModul(createModulInit)}
                        >
                            Batal
                        </AlertDialogCancel>
                    </AlertDialogContent>
                ...
                <AlertDialog
                    open={openDeleteModul}
                    onOpenChange={setOpenDeleteModul}
                >
                    <AlertDialogContent
                        className="max-w-[90%] sm:max-w-[425px] rounded"
                        onOpenAutoFocus={(e) => e.preventDefault()}
                    >
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="flex flex-col gap-0.5">
                                ...
                                <span className="*:text-red-600">
                                    Semua data Nilai Praktikan untuk modul{" "}
                                    <strong>"{deleteModul.nama}"</strong> akan
                                    juga dihapus
                                </span>
                                <br />
                                <span className="text-red-600">
                        ...
                        <form
                            className={cn("grid items-start gap-4")}
                            onSubmit={handleSubmitDeleteModul}
                        >
                            <div className="grid gap-2">
                                <Label htmlFor="validation">
                                    Validasi aksi anda
