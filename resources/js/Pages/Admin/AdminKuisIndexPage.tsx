...
import { ArrowUpDown, MoreHorizontal, Pencil, Trash2, Plus, Loader2, Users2 } from "lucide-react"
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={ () => router.visit(route('admin.kuis.result', { id: originalRow.id })) }>
                                <Users2 /> Hasil Kuis
                            </DropdownMenuItem>
