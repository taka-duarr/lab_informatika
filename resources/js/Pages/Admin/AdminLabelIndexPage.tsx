...
export default function AdminLabelIndexPage({
    auth,
    pagination,
}: PageProps<{
    ...
    const handleCreateFormSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        const namaSchema = z.object({
            nama: z
                ...
                .min(1, { message: "Nama Label wajib diisi!" }),
        });
    ...
    const handleUpdateFormSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        const updateSchema = z.object({
            id: z
                .string({ message: "Format Label tidak valid! " })
                .min(1, { message: "Format Label tidak valid!" }),
            nama: z
                .string({ message: "Format nama tidak valid! " })
                .min(1, { message: "Nama Label wajib diisi!" }),
        });
    ...
    return (
        <AdminLayout auth={auth}>
            ...
            <CardDescription>Data Label yang terdaftar</CardDescription>
            <div className="flex flex-col lg:flex-row gap-2 items-start justify-between">
                ...
                >
                    ...
                    >
                        <AlertDialogHeader>
                            <AlertDialogTitle>Tambah Label</AlertDialogTitle>
                            <AlertDialogDescription>
                                Label seperti <strong>Sistem Operasi</strong>{" "}
                                dan <strong>Modul 1</strong>
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <form
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="flex flex-col gap-0.5">
                            ...
                            <p className="*:text-red-600">
                                Semua data praktikum yang termasuk periode{" "}
