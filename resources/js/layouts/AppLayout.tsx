                ...
                <DialogContent className="max-w-[90%] sm:max-w-[500px] rounded">
                    <DialogHeader>
                        ...
                        <DialogDescription className="!mt-4 text-gray-900 font-medium">
                            Setelah puluhan entah ratusan kali melawan rasa
                            malas mengoding akhirnya kelar juga😁
                            <br />
                    ...
                    <ul className="pb-4 space-y-3">
                        <li className="grid grid-cols-12 gap-1 text-sm text-gray-800">
                            ...
                            <p className="col-span-11">
                                <strong> Halaman Admin</strong>, fitur yang bisa
                                digunakan yaitu Manajemen Praktikum yang
                                mencakup data Praktikum, Jenis Praktikum,
                                Periode Praktikum, kemudian Manajemen Praktikan
                                yang mencakup Data Praktikan dan Registrasi
                                Praktikan ke Praktikum, dan terakhir, Manajemen
                                Kuis yang mencakup Soal dan Label Soal.
                            </p>
                        </li>
                        <li className="grid grid-cols-12 gap-1 text-sm text-gray-800">
                            <img
                            ...
                            />
                            <p className="col-span-11">
                                <strong>Halaman Praktikan</strong>, memerlukan
                                autentikasi (login) untuk menggunakan beberapa
                                fitur seperti pengerjaan Kuis, Profil, dan
                                Registrasi Praktikum yang tentu saja mendukung
                    ...
                    <DialogDescription className="-mt-4 text-gray-900 font-medium">
                        ...
                        <ul className="list-inside list-disc">
                            ...
                            <li>
                                Bapak Septyawan Rosetya Wardhana S.Kom.,M.Kom.
                            </li>
